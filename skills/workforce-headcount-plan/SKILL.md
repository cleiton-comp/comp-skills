...
- **Claude Code**: `python3 scripts/headcount_plan.py ... --output plan.html` — roadmap função × trimestre, comparação de cenários, gráficos de headcount e custo (HTML Tailwind single-file).
