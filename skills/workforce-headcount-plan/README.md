...
Skill gratuito do Claude para líderes de RH & People. Constrói o **plano de headcount forward-looking** amarrado ao crescimento — projeta quantas pessoas contratar por função por trimestre, o custo incremental de folha, e 3 cenários (Conservador / Base / Agressivo).
