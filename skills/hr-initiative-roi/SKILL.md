...
- **Claude Code**: `python3 scripts/initiative_roi.py ... --output roi.html` — headline (ROI/payback/net 3a), barras custo vs benefício com marcador de payback, tabela de benefícios e sensibilidade (HTML Tailwind single-file).
