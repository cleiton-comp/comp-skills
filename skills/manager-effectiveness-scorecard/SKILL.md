...
- Gestores com **menos de 3 directs** são exibidos no relatório marcados como **"amostra pequena"**, mas ficam **fora de rankings, distribuição e do score médio**. Nunca baixe esse limite de 3 — protege a privacidade individual dos directs.
