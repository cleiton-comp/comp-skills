...
Skill gratuito do Claude para líderes de RH & People. Calcula o **Total Compensation** completo — cash (base + variável) + benefícios + equity (SOP/ILP com cenários de exit) — e devolve 2 headline numbers + breakdown + visão visual.
