...
Skill gratuito do Claude — **Chief of Staff conversacional do CHRO**. Mantém contexto persistente (stakeholders, cadências, calendário, open loops) e ajuda com pré-meeting briefs, visão semanal, drafts de comunicação, strategic prompts e orquestração com os outros skills da Comp.
...
Config persiste em `~/.comp-skills/chro-context.json` — todas as próximas execuções leem dele.
