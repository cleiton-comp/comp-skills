...
Skill gratuito do Claude para líderes de RH & People. Gera um assessment HTML interativo de prontidão para IA em RH, baseado no [AI Maturity Map da Comp](https://comp.vc/ai-maturity-map).
...
2. Telemetria anônima (default: off) — se ativada, envia nome do skill + timestamp por execução. **Nunca envia respostas, scores ou o HTML que você gera.**
