...
O artigo enfatiza avaliação qualitativa — o skill só consegue capturar o que estiver no CSV. CHRO precisa enriquecer dados pra extrair valor máximo. O skill identifica essa lacuna no output ("dados de IA não fornecidos — adicione coluna `ai_agents` pra análise completa").
